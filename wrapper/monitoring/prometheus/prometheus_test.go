...
import (
	...
	promwrapper "github.com/itzmanish/go-micro-plugins/wrapper/monitoring/prometheus/v2"
...
func TestPrometheusMetrics(t *testing.T) {
	...
	c := client.NewClient(client.WithRouter(client.DefaultClient.Options().Router))
